...
public:
	...
	/*14*/	virtual void	SetAmbientLightCube(Math::CVector4D cube[6]) = 0;
	...
	/*75*/	virtual float	ComputePixelWidthOfSphere(const Math::CVector& origin, float flRadius) = 0;
	...
	/*84*/	virtual float	ComputePixelDiameterOfSphere(const Math::CVector& vecAbsOrigin, float flRadius) = 0;
	...
	/*114*/	virtual void	SetVectorRenderingParameter(int parm_number, Math::CVector const& value) = 0;
	...
	/*146*/	virtual void	GetWorldSpaceCameraPosition(Math::CVector* pCameraPos) = 0;
	/*147*/	virtual void	GetWorldSpaceCameraVectors(Math::CVector* pVecForward, Math::CVector* pVecRight, Math::CVector* pVecUp) = 0;
	...
	/*151*/	virtual void	SetToneMappingScaleLinear(const Math::CVector& scale) = 0;
	/*152*/	virtual Math::CVector	GetToneMappingScaleLinear(void) = 0;
	...
	/*155*/	virtual void	SetLightingOrigin(Math::CVector vLightingOrigin) = 0;
	...
	/*163*/	virtual bool	GetMorphAccumulatorTexCoord(Math::CVector2D* pTexCoord, IMorph* pMorph, int nVertex) = 0;
