...
public:
	...
	virtual void					GetModelBounds(const model_t* model, Math::CVector& mins, Math::CVector& maxs) const = 0;
	virtual	void					GetModelRenderBounds(const model_t* model, Math::CVector& mins, Math::CVector& maxs) const = 0;
	...
	virtual void					GetModelMaterialColorAndLighting(const model_t* model, Math::CVector const& origin,
		Math::QAngle const& angles, trace_t* pTrace,
		Math::CVector& lighting, Math::CVector& matColor) = 0;
	virtual void					GetIlluminationPoint(const model_t* model, IClientRenderable* pRenderable, Math::CVector const& origin,
		Math::QAngle const& angles, Math::CVector* pLightingCenter) = 0;
	...
	virtual unsigned char			ComputeLevelScreenFade(const Math::CVector& vecAbsOrigin, float flRadius, float flFadeScale) const = 0;
	virtual unsigned char			ComputeViewScreenFade(const Math::CVector& vecAbsOrigin, float flRadius, float flFadeScale) const = 0;
	...
	virtual void					GetBrushModelPlane(const model_t* model, int nIndex, cplane_t& plane, Math::CVector* pOrigin) const = 0;
